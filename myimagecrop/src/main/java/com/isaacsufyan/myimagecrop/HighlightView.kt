...
class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth = ResourcesCompat.getDrawable(resources, R.drawable.camera_crop_width, null);
        mResizeDrawableHeight = ResourcesCompat.getDrawable(resources, R.drawable.camera_crop_height, null);
        mResizeDrawableDiagonal = ResourcesCompat.getDrawable(resources, R.drawable.indicator_autocrop, null);
    }
