...
import com.isaacsufyan.myimagecrop.R
import com.isaacsufyan.myimagecrop.HighlightView.ModifyMode
import com.isaacsufyan.myimagecrop.HighlightView
import android.graphics.drawable.Drawable
import android.view.View

internal open class HighlightView(private val mContext: View) {
    private fun init() {
        val resources = mContext.resources
        mResizeDrawableWidth =
            ResourcesCompat.getDrawable(resources, R.drawable.camera_crop_width, null)
        mResizeDrawableHeight =
            ResourcesCompat.getDrawable(resources, R.drawable.camera_crop_height, null)
        mResizeDrawableDiagonal =
            ResourcesCompat.getDrawable(resources, R.drawable.indicator_autocrop, null)
    }
        ...
        if (!hasFocus()) {
            ...
            if (mMode == ModifyMode.Grow) {
                if (mCircle) {
                    ...
                    val xMiddle = (mDrawRect!!.left
                            + (mDrawRect!!.right - mDrawRect!!.left) / 2)
                    val yMiddle = (mDrawRect!!.top
